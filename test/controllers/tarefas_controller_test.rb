...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference("Tarefa.count") do
      post tarefas_url, params: { tarefa: { custo: @tarefa.custo, datalimite: @tarefa.datalimite, name: @tarefa.name, ordem: @tarefa.ordem } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { custo: @tarefa.custo, datalimite: @tarefa.datalimite, name: @tarefa.name, ordem: @tarefa.ordem } }
